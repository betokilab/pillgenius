...
const adapter = new FileSync(path.join(dbDir, 'pill-genius.json'));
...
const sampleDrugs = [
  ...
  { id:5, item_seq:'D005', item_name:'메트포르민 500mg', entp_name:'보령제약', ingredient:'메트포르민염산염 500mg', class_name:'당뇨약', category:'drug', effect:'제2형 당뇨병 혈당 조절', dosage:'식사와 함께 1회 1정', caution:'신장기능 저하 시 주의, 조영제 검사 전 중단' },
  ...
  { id:14, item_seq:'S001', item_name:'오메가3 1000mg', entp_name:'종근당건강', ingredient:'EPA/DHA 혼합오일 1000mg', class_name:'건강기능식품', category:'supplement', effect:'혈중 중성지질 개선, 혈행 개선', dosage:'1일 1~2캡슐', caution:'항응고제 복용자 주의' },
  { id:15, item_seq:'S002', item_name:'비타민D 2000IU', entp_name:'고려은단', ingredient:'비타민D3 50mcg', class_name:'건강기능식품', category:'supplement', effect:'뼈·치아 건강, 면역 기능', dosage:'1일 1정', caution:'고용량 장기복용 시 고칼슘혈증' },
  { id:16, item_seq:'S003', item_name:'마그네슘 300mg', entp_name:'나우푸드', ingredient:'산화마그네슘 300mg', class_name:'건강기능식품', category:'supplement', effect:'에너지 생성, 신경·근육 기능', dosage:'1일 1~2정', caution:'설사 유발 가능' },
  { id:17, item_seq:'S004', item_name:'코엔자임Q10 100mg', entp_name:'솔가', ingredient:'유비퀴논 100mg', class_name:'건강기능식품', category:'supplement', effect:'항산화, 에너지 대사', dosage:'1일 1정', caution:'와파린 상호작용 가능' },
  { id:18, item_seq:'S005', item_name:'홍삼 600mg', entp_name:'정관장', ingredient:'홍삼분말 600mg', class_name:'건강기능식품', category:'supplement', effect:'면역력 증진, 피로 회복', dosage:'1일 3회 2캡슐', caution:'항응고제·혈압약 상호작용' },
  { id:19, item_seq:'S006', item_name:'은행잎 추출물 80mg', entp_name:'한국인스팜', ingredient:'은행잎 표준화 추출물 80mg', class_name:'건강기능식품', category:'supplement', effect:'혈행 개선, 기억력 지원', dosage:'1일 3회', caution:'항응고제·아스피린 병용 주의' },
  { id:20, item_seq:'S007', item_name:'철분제 30mg', entp_name:'한미약품', ingredient:'철(황산제일철) 30mg', class_name:'건강기능식품', category:'supplement', effect:'철 결핍성 빈혈 예방', dosage:'공복 복용', caution:'변비·흑변, 우유·커피 2시간 간격' },
];
...
db.defaults({ drugs: sampleDrugs, interactions: sampleInteractions, sync_logs: [], next_drug_id: 21, next_inter_id: 11 }).write();

console.log(`✅ 의약품/건기식 ${sampleDrugs.length}건 입력 완료`);
console.log(`✅ 상호작용 ${sampleInteractions.length}건 입력 완료`);
console.log('\n🎉 완료! 이제 npm start 를 실행하세요.\n');
